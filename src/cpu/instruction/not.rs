...
mod tests {
    ...
    fn not_byte_data_register_direct() {
        ...
        cpu.register.set_d_reg_long_no_log(7, 0xffffff80);
        ...
        // assert
        assert_eq!(0xffffff7f, cpu.register.get_d_reg_long_no_log(7));
    ...
    fn not_byte_data_register_direct_zero() {
        ...
        let code = [0x46, 0x07].to_vec(); // NOT.B D7
        let mut cpu = crate::instr_test_setup(code, None);
        cpu.register.set_d_reg_long_no_log(7, 0xffffffff);
        cpu.register.reg_sr.set_sr_reg_flags_abcde(
            STATUS_REGISTER_MASK_CARRY
                | STATUS_REGISTER_MASK_OVERFLOW
                | STATUS_REGISTER_MASK_ZERO
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0xffffff00, cpu.register.get_d_reg_long_no_log(7));
        assert_eq!(false, cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_overflow_set());
    ...
    fn not_byte_data_register_direct_negative() {
        ...
        let code = [0x46, 0x07].to_vec(); // NOT.B D7
        let mut cpu = crate::instr_test_setup(code, None);
        cpu.register.set_d_reg_long_no_log(7, 0xffffff7f);
        cpu.register.reg_sr.set_sr_reg_flags_abcde(
            STATUS_REGISTER_MASK_CARRY
                | STATUS_REGISTER_MASK_OVERFLOW
                | STATUS_REGISTER_MASK_ZERO
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0xffffff80, cpu.register.get_d_reg_long_no_log(7));
        assert_eq!(false, cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_zero_set());
    ...
    fn not_word_absolute_long_addressing_mode() {
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0x7fff, cpu.memory.get_word_no_log(0x00c00006));
        assert_eq!(false, cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn not_word_absolute_long_addressing_mode_zero() {
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0x0000, cpu.memory.get_word_no_log(0x00c00006));
        assert_eq!(false, cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(true, cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn not_word_absolute_long_addressing_mode_negative() {
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0x8fff, cpu.memory.get_word_no_log(0x00c00006));
        assert_eq!(false, cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(true, cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn not_long_address_register_indirect() {
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0x7fffffff, cpu.memory.get_long_no_log(0x00c00002));
        assert_eq!(false, cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn not_long_address_register_indirect_negative() {
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0x8fffffff, cpu.memory.get_long_no_log(0x00c00002));
        assert_eq!(false, cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(true, cpu.register.reg_sr.is_sr_negative_set());
