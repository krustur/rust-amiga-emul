...
mod tests {
    ...
    fn not_byte_data_register_direct() {
        ...
        cpu.register.reg_d[7] = 0xffffff80;
        ...
        // assert
        assert_eq!(0xffffff7f, cpu.register.reg_d[7]);
    ...
    fn not_byte_data_register_direct_zero() {
        ...
        let code = [0x46, 0x07].to_vec(); // NOT.B D7
        let mut cpu = crate::instr_test_setup(code, None);
        cpu.register.reg_d[7] = 0xffffffff;
        cpu.register.reg_sr = STATUS_REGISTER_MASK_CARRY
            | STATUS_REGISTER_MASK_OVERFLOW
            | STATUS_REGISTER_MASK_ZERO
            | STATUS_REGISTER_MASK_NEGATIVE;
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0xffffff00, cpu.register.reg_d[7]);
        assert_eq!(false, cpu.register.is_sr_carry_set());
        assert_eq!(false, cpu.register.is_sr_overflow_set());
    ...
    fn not_byte_data_register_direct_negative() {
        ...
        let code = [0x46, 0x07].to_vec(); // NOT.B D7
        let mut cpu = crate::instr_test_setup(code, None);
        cpu.register.reg_d[7] = 0xffffff7f;
        cpu.register.reg_sr = STATUS_REGISTER_MASK_CARRY
            | STATUS_REGISTER_MASK_OVERFLOW
            | STATUS_REGISTER_MASK_ZERO
            | STATUS_REGISTER_MASK_NEGATIVE
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0xffffff80, cpu.register.reg_d[7]);
        assert_eq!(false, cpu.register.is_sr_carry_set());
        assert_eq!(false, cpu.register.is_sr_overflow_set());
        assert_eq!(false, cpu.register.is_sr_zero_set());
