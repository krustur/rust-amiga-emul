...
mod tests {
    ...
    fn not_byte_data_register_direct() {
        ...
        mm.step();
        // assert
        assert_eq!(0xffffff7f, mm.cpu.register.get_d_reg_long_no_log(7));
    ...
    fn not_byte_data_register_direct_negative() {
        ...
        let code = [0x46, 0x07].to_vec(); // NOT.B D7
        let mut mm = crate::tests::instr_test_setup(code, None);
        mm.cpu.register.set_d_reg_long_no_log(7, 0xffffff7f);
        mm.cpu.register.reg_sr.set_sr_reg_flags_abcde(
            STATUS_REGISTER_MASK_CARRY
                | STATUS_REGISTER_MASK_OVERFLOW
                | STATUS_REGISTER_MASK_ZERO
    ...
    fn not_word_absolute_long_addressing_mode() {
        ...
        mm.step();
        // assert
        assert_eq!(0x7fff, mm.mem.get_word_no_log(0x00c00006));
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn not_word_absolute_long_addressing_mode_negative() {
        ...
        mm.step();
        // assert
        assert_eq!(0x8fff, mm.mem.get_word_no_log(0x00c00006));
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(true, mm.cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn not_long_address_register_indirect() {
        ...
        mm.step();
        // assert
        assert_eq!(0x7fffffff, mm.mem.get_long_no_log(0x00c00002));
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn not_long_address_register_indirect_negative() {
        ...
        mm.step();
        // assert
        assert_eq!(0x8fffffff, mm.mem.get_long_no_log(0x00c00002));
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(true, mm.cpu.register.reg_sr.is_sr_negative_set());
