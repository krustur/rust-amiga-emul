...
mod tests {
    ...
    fn andi_to_sr_word_0000() {
        ...
        mm.cpu.register.reg_sr.set_sr_reg_flags_abcde(0xffff);
        // act assert - debug
        ...
        mm.step();
        // assert
        assert_eq!(0x0000, mm.cpu.register.reg_sr.get_value());
    ...
    fn andi_to_sr_word_ffff() {
        ...
        mm.step();
        // assert
        assert_eq!(0xffff, mm.cpu.register.reg_sr.get_value());
