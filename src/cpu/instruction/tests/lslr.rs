// Path: ..\src\cpu\instruction\tests\lslr.rs
...
fn this_test_is_for_testing_purposes_only() {
    ...
    let code_memory = RamMemory::from_bytes(0x00c00000, code);
    ...
    cpu.register.set_all_a_reg_long_no_log(0x000000a0, 0x000000a1, 0x000000a2, 0x000000a3, 0x000000a4, 0x000000a5, 0x000000a6);
    cpu.register.reg_pc = ProgramCounter::from_address(0x00c00000);
    ...
    cpu.register.assert_all_a_reg_long_no_log(0x000000a0, 0x000000a1, 0x000000a2, 0x000000a3, 0x000000a4, 0x000000a5, 0x000000a6);
