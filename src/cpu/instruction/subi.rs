...
mod tests {
    ...
    fn subi_byte_immediate_data_to_data_register_direct() {
        ...
        mm.cpu.register.set_d_reg_long_no_log(7, 0x00004325);
        ...
        mm.step();
        // assert
        assert_eq!(0x4302, mm.cpu.register.get_d_reg_long_no_log(7));
    ...
    fn subi_byte_immediate_data_to_absolute_short() {
        ...
        mm.step();
        // assert
        assert_eq!(0x4c, mm.mem.get_byte_no_log(0x00006000));
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_carry_set());
    ...
    fn subi_word_immediate_data_to_data_register_direct() {
        ...
        mm.step();
        // assert
        assert_eq!(0x30ED, mm.cpu.register.get_d_reg_long_no_log(7));
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn subi_word_immediate_data_to_absolute_long() {
        ...
        mm.step();
        // assert
        assert_eq!(0x3C09, mm.mem.get_word_no_log(0x00060000));
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn subi_long_immediate_data_to_data_register_direct() {
        ...
        let mut mm = crate::tests::instr_test_setup(code, None);
        mm.cpu.register.set_d_reg_long_no_log(0, 0x76857685);
        mm.cpu.register.reg_sr.set_sr_reg_flags_abcde(
            STATUS_REGISTER_MASK_CARRY
                | STATUS_REGISTER_MASK_OVERFLOW
                | STATUS_REGISTER_MASK_ZERO
        ...
        mm.step();
        // assert
        assert_eq!(0x66756675, mm.cpu.register.get_d_reg_long_no_log(0));
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(false, mm.cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn subi_long_immediate_data_to_absolute_long() {
        ...
        mm.step();
        // assert
        assert_eq!(0xeC090001, mm.mem.get_long_no_log(0x00040000));
