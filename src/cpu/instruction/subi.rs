...
mod tests {
    ...
    fn subi_byte_immediate_data_to_data_register_direct() {
        ...
        cpu.register.set_d_reg_long_no_log(7, 0x00004325);
        ...
        // assert
        assert_eq!(0x4302, cpu.register.get_d_reg_long_no_log(7));
    ...
    fn subi_byte_immediate_data_to_absolute_short() {
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0x4c, cpu.memory.get_byte_no_log(0x00006000));
        assert_eq!(false, cpu.register.reg_sr.is_sr_carry_set());
    ...
    fn subi_word_immediate_data_to_data_register_direct() {
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0x30ED, cpu.register.get_d_reg_long_no_log(7));
        assert_eq!(false, cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn subi_word_immediate_data_to_absolute_long() {
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0x3C09, cpu.memory.get_word_no_log(0x00060000));
        assert_eq!(false, cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn subi_long_immediate_data_to_data_register_direct() {
        ...
        let mut cpu = crate::instr_test_setup(code, None);
        cpu.register.set_d_reg_long_no_log(0, 0x76857685);
        cpu.register.reg_sr.set_sr_reg_flags_abcde(
            STATUS_REGISTER_MASK_CARRY
                | STATUS_REGISTER_MASK_OVERFLOW
                | STATUS_REGISTER_MASK_ZERO
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0x66756675, cpu.register.get_d_reg_long_no_log(0));
        assert_eq!(false, cpu.register.reg_sr.is_sr_carry_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_overflow_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_zero_set());
        assert_eq!(false, cpu.register.reg_sr.is_sr_negative_set());
    ...
    fn subi_long_immediate_data_to_absolute_long() {
        ...
        cpu.execute_next_instruction();
        // assert
        assert_eq!(0xeC090001, cpu.memory.get_long_no_log(0x00040000));
