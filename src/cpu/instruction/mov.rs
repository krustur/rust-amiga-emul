...
pub fn step<'a>(
    ...
    match size {
        OperationSize::Byte => {
            let data = Cpu::get_ea_value_unsigned_byte(src_ea_mode, src_ea_register, instr_address, reg, mem);
        }
        OperationSize::Word => {
            let data = Cpu::get_ea_value_unsigned_word(src_ea_mode, src_ea_register, instr_address, reg, mem);
        }
        OperationSize::Long => {
            let get_data_result = Cpu::get_ea_value_unsigned_long(src_ea_mode, src_ea_register, instr_address, reg, mem);
