...
impl KickstartDebug for KickstartDebug_3_1_4 {
    fn get_address_comment(&self, pc_address: u32) -> Option<String> {
        match pc_address {
            ...
            0x00F802E0 => Some(String::from("AttnFlags")),
            ...
            0x00F81ACE => Some(String::from("ExecLibrary.FindName -276 node D0,Z=FindName(start A0, name A1) http://amigadev.elowar.com/read/ADCD_2.1/Includes_and_Autodocs_2._guide/node034E.html")),
            // tasks
    ...
    fn should_print_registers_after_step(&self, pc_address: u32) -> bool {
        match pc_address {
            ...
            0x00F83E8E => true, // ExecLibrary.Alertish
    ...
    fn should_dump_memory_after_step(&self, pc_address: u32) -> Option<(u32, u32)> {
        match pc_address {
            ...
            0x00FC087E => Some((0x00fc077a, 0x00fc077a + 32)), // A6=What Library (name)?
